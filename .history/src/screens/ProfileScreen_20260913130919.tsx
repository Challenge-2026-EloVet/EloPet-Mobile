      ...
      >
        ...
        <View style={styles.sectionContainer}>
          ...
          <PetCard
            pets={pets}
            onEdit={(pet: Pet) => {
              // Lógica de edição (ex: navegar para tela de edição passando o pet)
              console.log('Editar pet:', pet);
            }}
            onDelete={(pet: Pet) => {
              // Lógica de exclusão (ex: chamar service de delete e invalidar query)
              console.log('Excluir pet:', pet);
            }}
            onAddPress={() => navigation.navigate('RegisterPetScreen')}
          />
        </View>
