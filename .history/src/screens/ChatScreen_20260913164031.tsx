...
const initialMessage: Message = {
  id: 'welcome',
  text: 'Olá! Como seu pet se comportou hoje com relação ao apetite e energia? 🐾',
  sender: 'assistant',
};
...
function getAssistantReply(reply: string) {
  ...
  if (reply === quickReplies[1]) {
    return `Obrigada por me contar. Registrei a redução do apetite. Ofereça água e observe o pet. Caso se ele recusar a próxima refeição, avise a clínica. 💚`;
  }
