...
export default function ProfileScreen() {
  ...
  // COM O SCROLLVIEW DA PROFILESCREEN, ENTAO CRIEI ESTRUTURA DE HEADER E FOOTER PARA O PETCARD, E COLOQUEI O SCROLLVIEW DENTRO DO PETCARD, 
  // ASSIM ELE CONSEGUE RENDERIZAR OS PETS COM O SWIPELISTVIEW SEM CRASHAR
  return (
