      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contactCard}>
          ...
          <View style={styles.contactDetailsList}>
            ...
            <View style={styles.contactItem}>
              <Ionicons name="id-card-outline" size={16} color="#7E9F8E" />
              <Text style={styles.contactItemText}>{rg || 'Não informado'}</Text>
            </View>
            <View style={styles.contactItem}>
              <Ionicons name="card-outline" size={16} color="#7E9F8E" />
              <Text style={styles.contactItemText}>{cpf || 'Não informado'}</Text>
            </View>
          </View>
        </View>
