...
const API_PETS_URL = process.env.EXPO_PUBLIC_API_JAVA_PETS;

// Função auxiliar para pegar o token de autenticação (caso sua API exija Bearer Token)
// Se você estiver salvando o token no AsyncStorage ou Context, ajuste aqui:
 ...
 * @param {Object} petData - Dados do pet (ex: { name, age, breed, weight, etc })
 */
