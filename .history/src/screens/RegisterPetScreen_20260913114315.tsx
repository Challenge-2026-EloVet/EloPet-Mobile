  ...
  const handleRegisterPet = async () => {
    ...
    try {
      ...
      const petPayload = {
        ...
        especie: species,
        raca: breed.trim(),
        idadeAproximada: age.trim(),
        peso: weight ? weight.replace(',', '.') : null,
        idResponsavel: userId, // Ajuste para a chave esperada pelo seu backend Java se for idResponsavel ou responsavelId
      };

      await createPetService(petPayload);
